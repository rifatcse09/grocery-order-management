...
> = {
  ...
  moderator: [
    ...
    { to: "/moderator/suppliers", label: "Suppliers", icon: Building2 },
    { to: "/moderator/purchase-orders", label: "Purchase orders", icon: Truck },
    { to: "/moderator/inventory", label: "Inventory dashboard", icon: Warehouse },
    { to: "/moderator/inventory/stock", label: "Stock list", icon: Package },
    { to: "/moderator/inventory/movements", label: "Stock movements", icon: BarChart3 },
  ],
  admin: [
    ...
    { to: "/admin/inventory", label: "Inventory dashboard", icon: Warehouse },
    { to: "/admin/inventory/stock", label: "Stock list", icon: Package },
    { to: "/admin/inventory/movements", label: "Stock movements", icon: BarChart3 },
    { to: "/admin/inventory/bills", label: "Inventory bills", icon: FileText },
    { to: "/admin/inventory/adjustments", label: "Returns & damages", icon: ShieldAlert },
